...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/div_History                                _b9332f'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_CURA Healthcare Service/div_History                                _b9332f'))
